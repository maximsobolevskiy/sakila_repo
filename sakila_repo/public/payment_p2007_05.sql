...
(
    ...
    CONSTRAINT payment_p2007_05_payment_date_check CHECK ((payment_date >= '2007-05-01 00:00:00'::timestamp without time zone) AND
...
CREATE INDEX idx_fk_payment_p2007_05_customer_id ON public.payment_p2007_05 (customer_id);

CREATE INDEX idx_fk_payment_p2007_05_staff_id ON public.payment_p2007_05 (staff_id);
