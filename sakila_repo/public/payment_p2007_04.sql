...
(
    ...
    CONSTRAINT payment_p2007_04_payment_date_check CHECK ((payment_date >= '2007-04-01 00:00:00'::timestamp without time zone) AND
...
CREATE INDEX idx_fk_payment_p2007_04_customer_id ON public.payment_p2007_04 (customer_id);

CREATE INDEX idx_fk_payment_p2007_04_staff_id ON public.payment_p2007_04 (staff_id);
