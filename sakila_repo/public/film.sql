...
(
    ...
    description          text,
    release_year         year,
    language_id          smallint                                                    NOT NULL REFERENCES public.language ON UPDATE CASCADE ON DELETE RESTRICT,
    original_language_id smallint REFERENCES public.language ON UPDATE CASCADE ON DELETE RESTRICT,
